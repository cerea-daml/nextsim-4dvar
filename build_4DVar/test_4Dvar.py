...
inflation = 1
test = FourDVar(model, mask, obs_op = 'multi',starting_time = 0, k = 20, ftol = 1e-6,inflation = inflation, N_cycle = N_cycle, std_obs = 0.4, std_back = 1, time_window = time_window, timestep = 1,
